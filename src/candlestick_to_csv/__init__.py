...
class digitize:
    ...
    def stkEnds(self, data_new, vLinesX_new):
        ...
        #Finds the first day for each month and sets 'startEnd[i, 2] = 1' for this day
        #Also finds days after Saturday and sets 'startEnd[i, 3] = 1' for this day
        #(there is no market data for Saturdays)
        #We need them to find the correct date for each candlestick
        del i
        n = 0
